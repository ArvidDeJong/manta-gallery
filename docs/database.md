...
This document describes the database schema for the Manta Gallery Form package.

## Tables

### gallerys Table

The main table for storing gallery form submissions.
...
| `internal_gallery` | string    | Internal gallery reference     |
...
// Query examples
$activeGallerys = gallery::where('active', true)->get();
$recentGallerys = gallery::orderBy('created_at', 'desc')->limit(10)->get();
$gallerysByCompany = gallery::where('company_id', 1)->get();
```
...
```
database/migrations/2024_07_26_091749_create_gallerys_table.php
```
